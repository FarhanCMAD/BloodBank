...
import bloodTypes from '../images/bloodTypes.png';
    ...
    handleChange = (event, index, value) => this.setState({value});
      ...
      render(){
          return(
            ...
            iconElementRight={  <div><FlatButton  label="logout" disabled={true} 
            labelStyle={style.labelStyle} onClick={this.Logout.bind(this)} containerElement={<Link to='/' />}
            />  
...
<br/> <br/>
  ...
  /></ Link><br /><br />
   ...
   <SelectField
        ...
        <img src = {bloodTypes } alt="" width="25%"/>
        <Table>
